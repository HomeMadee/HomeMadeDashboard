...
class RestaurantAPIController extends Controller
{
    ...
    public function __construct(RestaurantRepository $restaurantRepo, CustomFieldRepository $customFieldRepo, UploadRepository $uploadRepo, CategoryRepository $catRepo, CuisineRepository $cuisineRepo)
    {
        parent::__construct();
    ...
    public function show(Request $request, $id)
    {
        ...
        foreach ($cuisinesSelected as $item) {
            # code...
            if (!empty($this->categoryRepository)) {
                $category = $this->categoryRepository->findByField('cuisine_id', ($item))->toArray();
        ...
        $restaurant->mainCategories = $mainCategories;
