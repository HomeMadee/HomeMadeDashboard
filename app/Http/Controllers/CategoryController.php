...
class CategoryController extends Controller
{
   ...
   /**
    ...
    public function __construct(CategoryRepository $categoryRepo, CustomFieldRepository $customFieldRepo, UploadRepository $uploadRepo, CuisineRepository $cuisineRepository)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        return view('categories.create')->with('cuisine', $cuisine)->with("customFields", isset($html) ? $html : false);
    }
    ...
    public function edit($id)
    {
        ...
        return view('categories.edit')->with('category', $category)->with("cuisine",$cuisine)->with("customFields", isset($html) ? $html : false);
    }
