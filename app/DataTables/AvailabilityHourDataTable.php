...
class AvailabilityHourDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('restaurant_id.name', function ($availabilityHour) {
                return getLinksColumnByRouteName([$availabilityHour->restaurant], 'restaurant.edit', 'id', 'name');
            })
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                ...
                'title' => trans('lang.availability_hour'),
    ...
    public function query(AvailabilityHour $model)
    {
        if (auth()->user()->hasRole('admin')) {
            return $model->newQuery()->with("restaurant")->join('user_restaurants', 'user_restaurants.restaurant', '=', 'availability_hours.restaurant_id')
